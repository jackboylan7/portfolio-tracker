...
if st.session_state.current_portfolio == "All":
    ...
    if not st.session_state.portfolios:
        st.markdown("""
        ## Welcome to BEZZ Advanced Multi-Portfolio Stock Tracker!
        
        **To get started, create a portfolio and add stocks to it.**
        
        Here's how:
        1. Use the sidebar on the left to create a new portfolio.
        2. Select your newly created portfolio from the dropdown.
        3. Add stocks to your portfolio using the form in the sidebar.
        
        Once you've added stocks to your portfolio, you'll see a summary and performance analysis here.
        """)
    else:
        # Fetch S&P 500 data
        ...
        if portfolio_performances:
            ...
            st.info("Your portfolios are empty. Add some stocks to see the analysis!")
